/**
 * BUILD "watches-atticfortune" (Walt Hargrove) — listicle EN: old watches worth a fortune. EARTH.
 * B-roll = imágenes Agnes (imgmap). QR ×6 (qr_attic). CTA = SplitInfo + QRTag.
 *   node scripts/build_watches.mjs
 */
import fs from "node:fs";
import path from "node:path";
const ROOT = process.cwd();
const SLUG = "watches-atticfortune";
const FPS = 30;
const T = "earth";
...
const compBeats = [
  ["some of those old watches", 5, "BigStat", { theme: T, eyebrow: "ONE OLD WATCH", prefix: "$", value: 6000, suffix: "?", support: "what a forgotten Swiss chrono can bring" }],
  ["a whole new wave of collectors", 6, "Checklist", { theme: T, title: "Why old watches pay now", items: ["Millions dropped in drawers when phones arrived", "Vintage mechanical watches are back in demand", "The right ones sell for real money"] }],
  ["watches come in two big families", 6, "Compare", { theme: T, title: "Mechanical vs. quartz", left: { label: "MECHANICAL", sub: "gears & springs — what collectors chase" }, right: { label: "QUARTZ", sub: "battery, made by the millions — worth little" } }],
  ["mistaken for junk", 7, "MythVsTruth", { theme: T, mythLabel: "Myth", truthLabel: "Truth", myth: "It's just an old wristwatch, it's worth nothing.", truth: "A genuine vintage piece from a good maker routinely sells for hundreds, and the desirable ones climb into the thousands." }],
  ["how do you tell if yours is worth something", 8, "Steps", { theme: T, eyebrow: "HOW TO VALUE IT", title: "Check it in 4 steps", steps: [{ title: "The movement", sub: "mechanical beats battery" }, { title: "Dial & back", sub: "maker, 'automatic', gold stamps, serials" }, { title: "Condition & completeness", sub: "box, papers, bracelet" }] }],
  ["the only difference between the person", 6, "PullQuote", { theme: T, quote: "The only difference between the person who gave it away and the person who cashed in was knowing what to look for.", author: "Walt Hargrove" }],
];
const components = [];
const compMiss = [];
...
const ovBeats = [
  ...
  ["put together a complete guide", 6.5, "SplitInfo", { eyebrow: "FREE GUIDE", title: "The Attic Fortune Guide", items: ["Exact brands, models & price ranges", "How to spot fakes & value your piece", "Watches, coins, tools & more"] }],
  ...
  ["the whole reason i made that guide", 6.5, "SplitInfo", { eyebrow: "EVERYTHING INSIDE", title: "The Attic Fortune Guide", items: ["Identify your watch step by step", "What collectors pay right now", "Link pinned in the comments"] }],
  ["old ladies cocktail", 4, "SectionTitle", { theme: T, eyebrow: "#10", title: "Ladies' Dress Watches" }],
  ["vintage chronographs", 4, "SectionTitle", { theme: T, eyebrow: "#9", title: "Chronographs" }],
  ["issued to soldiers", 4, "SectionTitle", { theme: T, eyebrow: "#8", title: "Military Watches" }],
  ["railroad pocket watches", 4, "SectionTitle", { theme: T, eyebrow: "#7", title: "Railroad Pocket Watches" }],
  ["swiss dress watches", 4, "SectionTitle", { theme: T, eyebrow: "#6", title: "Swiss Dress Watches" }],
  ["vintage dive watches", 4, "SectionTitle", { theme: T, eyebrow: "#5", title: "Dive Watches" }],
  ["an automatic winds itself", 4, "SectionTitle", { theme: T, eyebrow: "#4", title: "Mid-Century Automatics" }],
  ["watches in solid gold", 4, "SectionTitle", { theme: T, eyebrow: "#3", title: "Solid Gold" }],
  ["the forgotten name brand", 4, "SectionTitle", { theme: T, eyebrow: "#2", title: "The Drawer Wristwatch" }],
  ["any collectible watch in its complete", 4.5, "SectionTitle", { theme: T, eyebrow: "#1", title: "Full Set" }],
  ["at least its weight in gold", 4.5, "StatChip", { theme: T, prefix: "$", value: 1000, label: "a solid gold case, at minimum", corner: "tr" }],
  ["worth over six thousand dollars", 3.6, "KeywordPop", { theme: T, word: "$6,000+", sub: "the watch in the sock", pos: "center" }],
  ["have it polished or take it apart", 5, "Callout", { theme: T, label: "Caution", icon: "🚫", title: "Never polish or open it", sub: "buffing wipes the value right off", tone: "warn" }],
  ...
  // QR ×6
  ["some of those old watches", 7, "QRTag", { ...QR }],
  ["put together a complete guide", 8, "QRTag", { ...QR }],
  ["watches in solid gold", 7, "QRTag", { ...QR }],
