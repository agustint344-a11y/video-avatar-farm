/**
 * BUILD "vinyl-atticfortune" (Walt Hargrove) — listicle EN: old vinyl records worth a fortune. EARTH.
 * B-roll = imágenes Agnes (imgmap). QR ×6 (qr_attic). CTA = SplitInfo + QRTag.
 *   node scripts/build_vinyl_atticfortune.mjs
 */
import fs from "node:fs";
import path from "node:path";
const ROOT = process.cwd();
const SLUG = "vinyl-atticfortune";
const FPS = 30;
const T = "earth";
...
const compBeats = [
  ["some of those old records", 5, "BigStat", { theme: T, eyebrow: "ONE OLD RECORD", prefix: "$", value: 5000, suffix: "?", support: "what a rare first pressing can bring" }],
  ["two copies of the very same record", 6, "Checklist", { theme: T, title: "Why old records pay now", items: ["The pressing matters more than the album", "First pressings & promos are chased", "Clean & complete sells for real money"] }],
  ["the very first pressing the original", 6, "Compare", { theme: T, title: "First pressing vs. reprint", left: { label: "FIRST PRESSING", sub: "original run — worth 10–20x more" }, right: { label: "LATER REPRINT", sub: "made by the millions — worth little" } }],
  ["so folks naturally assume every single", 7, "MythVsTruth", { theme: T, mythLabel: "Myth", truthLabel: "Truth", myth: "Everybody owned it, so every copy is worth a dollar.", truth: "The first pressing or a pulled-cover version can bring hundreds or thousands, while the common copy is worth almost nothing." }],
  ["so how do you tell if yours", 8, "Steps", { theme: T, eyebrow: "HOW TO VALUE IT", title: "Check it in 4 steps", steps: [{ title: "Pressing & label", sub: "early original beats reprint" }, { title: "Condition", sub: "clean vinyl & clean cover" }, { title: "Complete & original", sub: "sleeve, inserts, ideally sealed" }] }],
...
const ovBeats = [
  ...
  ["before you toss it before you", 3.4, "KeywordPop", { theme: T, word: "CHECK ITS WORTH", sub: "before you toss it", pos: "bottom" }],
  ["it comes down to one word the pressing", 3.6, "KeywordPop", { theme: T, word: "IT'S THE PRESSING", sub: "which version, not just the album", pos: "center" }],
  ["put together a complete guide", 6.5, "SplitInfo", { eyebrow: "FREE GUIDE", title: "The Attic Fortune Guide", items: ["Exact records, pressings & price ranges", "How to spot the valuable versions", "Records, coins, tools & more"] }],
  ...
  ["the whole reason i put that guide", 6.5, "SplitInfo", { eyebrow: "EVERYTHING INSIDE", title: "The Attic Fortune Guide", items: ["Identify your records step by step", "What collectors pay right now", "Link pinned in the comments"] }],
  ["classic rock albums but the first", 4, "SectionTitle", { theme: T, eyebrow: "#10", title: "Classic Rock First Pressings" }],
  ["jazz records on the right labels", 4, "SectionTitle", { theme: T, eyebrow: "#9", title: "Jazz on the Right Labels" }],
  ["blues and early rock and roll", 4, "SectionTitle", { theme: T, eyebrow: "#8", title: "Blues & Early Rock'n'Roll" }],
  ["soul funk and what collectors call", 4, "SectionTitle", { theme: T, eyebrow: "#7", title: "Soul, Funk & Rare Groove" }],
  ["original movie soundtracks", 4, "SectionTitle", { theme: T, eyebrow: "#6", title: "Movie Soundtracks" }],
  ["picture discs colored vinyl and promos", 4, "SectionTitle", { theme: T, eyebrow: "#5", title: "Picture Discs, Colored & Promos" }],
  ["records still sealed in the wrapper", 4, "SectionTitle", { theme: T, eyebrow: "#4", title: "Still Sealed" }],
  ["early rare singles and rockabilly", 4, "SectionTitle", { theme: T, eyebrow: "#3", title: "Rare Singles & Rockabilly" }],
  ["the famous album that everybody owned", 4.5, "SectionTitle", { theme: T, eyebrow: "#2", title: "The Famous Album, Rare Pressing" }],
  ["any rare original pressing in clean", 4.5, "SectionTitle", { theme: T, eyebrow: "#1", title: "Rare Original, Complete" }],
  ["he almost sold for a dollar", 3.6, "KeywordPop", { theme: T, word: "$5,000+", sub: "the jazz record in the milk crate", pos: "center" }],
  ["never ever play a potentially", 5, "Callout", { theme: T, label: "Caution", icon: "🚫", title: "Don't clean or play it carelessly", sub: "a worn needle or harsh cleaning wrecks the value", tone: "warn" }],
  ...
  // QR ×6
  ["some of those old records", 7, "QRTag", { ...QR }],
  ["put together a complete guide", 8, "QRTag", { ...QR }],
  ["records still sealed in the wrapper", 7, "QRTag", { ...QR }],
